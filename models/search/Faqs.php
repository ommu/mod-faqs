 ...
 * Faqs
 *
 * Faqs represents the model behind the search form about `ommu\faq\models\Faqs`.
 *
...
use ommu\faq\models\Faqs as FaqsModel;
...
class Faqs extends FaqsModel
{
	...
	public function search($params, $column=null)
	{
        if (!($column && is_array($column))) {
            ...
            $query = FaqsModel::find()->alias('t')->select($column);
        }
		$query->joinWith([
			'view view', 
