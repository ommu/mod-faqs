 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_faq_statistic_total".
 *
 * The followings are the available columns in table 'ommu_faq_statistic_total':
 * @property string $statistic_key
 * @property integer $total
 * @property integer $flag
 * @property string $note
 */
class FaqStatisticTotal extends CActiveRecord
{
	 ...
	 * @return FaqStatisticTotal the static model class
	 */
	...
	{
		return 'ommu_faq_statistic_total';
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('FaqStatisticTotal_sort'))
