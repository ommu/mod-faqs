...
$this->params['menu']['content'] = [
	...
	['label' => Yii::t('app', 'Delete'), 'url' => Url::to(['delete', 'id' => $model->like_id]), 'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post', 'icon' => 'trash'],
];
?>
...
<?php echo DetailView::widget([
	...
	'attributes' => [
		...
		[
			...
			'value' => !in_array($model->likes_date, ['0000-00-00 00:00:00','1970-01-01 00:00:00','-0001-11-30 00:00:00']) ? Yii::$app->formatter->format($model->likes_date, 'datetime') : '-',
		],
		'likes_ip',
		[
