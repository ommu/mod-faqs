 ...
 * @var $this app\modules\faq\controllers\__\HelpfulController
 ...
 * @created date 30 April 2018, 09:07 WIB
...
$this->params['breadcrumbs'][] = ['label' => $model->faq->category->title->message, 'url' => ['view', 'id' => $model->id]];
