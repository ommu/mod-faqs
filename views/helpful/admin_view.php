...
<?php echo DetailView::widget([
	...
	'attributes' => [
		...
		[
			...
			'value' => !in_array($model->helpful_date, ['0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00']) ? Yii::$app->formatter->format($model->helpful_date, 'datetime') : '-',
		],
		'helpful_ip',
		[
