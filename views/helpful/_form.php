...
<?php echo $form->field($model, 'helpful', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12">{input}{error}</div>'])
	->dropDownList([ '0', '1', ], ['prompt' => ''])
...
<?php echo $form->field($model, 'helpful_ip', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12">{input}{error}</div>'])
	->textInput(['maxlength' => true])
	->label($model->getAttributeLabel('helpful_ip'), ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']); ?>
