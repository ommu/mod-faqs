 ...
 * @created date 5 January 2018, 10:20 WIB
...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Faq Category'), 'url' => Url::to(['create']), 'icon' => 'plus-square'],
];
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View Faq Category')]);
					},
